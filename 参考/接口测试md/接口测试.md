...
| 6    | http://114.212.245.120:7788/uerManage/register               | 用户注册                           | 500 服务器异常，未崩溃                              |
| 7    | http://114.212.245.120:7788/api/config/add                   | 模型配置模块的添加模型             | 200 + 40000                                         |
| 8    | http://114.212.245.120:7788/api/config/get/all               | 获取现有的所有机器学习配置模型     | 200 + 40000                                         |
| 9    | http://114.212.245.120:7788/api/config/get/one/config?configId=0 | 根据id获取某个机器学习模型         | 200 + 40000                                         |
| 10   | http://114.212.245.120:7788/api/file/upload?userId=0&fileName=hello.csv | 上传文件                           | 200 + 服务器报了一个error，但没崩溃                 |
...
| 14   | http://114.212.245.120:7788/api/picture/update/picinfo?picId=0&picCategory=0&picTag=animal | 更新图片的类别信息和标签信息       | 200                                                 |
| 15   | http://114.212.245.120:7788/api/model/get/all?userId=1       | 获得用户所有机器学习模型           | 200                                                 |
| 16   | http://114.212.245.120:7788/api/model/train?modelId=0        | 使用模型进行训练                   | 200                                                 |
